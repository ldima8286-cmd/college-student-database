        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between gap-2 min-h-16 py-2">
            <div className="flex items-center gap-3 min-w-0">
              <Link to={isAdmin() ? '/admin' : '/'} className="btn btn-ghost text-sm flex items-center gap-1 flex-shrink-0">
                <ArrowLeft className="w-4 h-4" />
              </Link>
              <User className="w-6 h-6 text-primary-600 flex-shrink-0" />
              <h1 className="text-lg font-bold text-gray-900 dark:text-white truncate">Профиль</h1>
            </div>
            <ThemeToggle />
          </div>
        </div>
